...
function Cart() {
  ...
  const onRemoveItem = (id) => {
    if(window.confirm('убрать пиццу?')){
  ...
  const onClearCart = () => {
    if(addedPizzas.length !== 0 && window.confirm("Вы действительно хотите очистить корзину?")){
      dispatch(clearCart());
    }
                ...
                <div className="cart__bottom">
                  ...
                  <div className="cart__bottom-buttons">
                    ...
                    <div className="button pay-btn">
                      <span onClick={onOrder} >Оплатить сейчас</span>
                    </div>
                  </div>
                </div>
              </div>
